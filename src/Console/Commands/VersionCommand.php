...
class VersionCommand extends Command {
    ...
    public function handle(): int {
        $version = '1.51.0'; // feat(smtp): SMTP Settings admin page — live .env editing (MAIL_*), preset CRUD with encrypted passwords, apply-preset to .env, tabular Use Preset picker, Save current as preset, danger-confirmed cache clear, and Esc-aware modals
