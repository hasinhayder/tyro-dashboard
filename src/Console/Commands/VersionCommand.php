...
class VersionCommand extends Command {
    ...
    public function handle(): int {
        $version = '1.36.0'; // Added sidebar and essentials publish targets
...
// Changelog
// 1.36.0 - Added tyro-dashboard:publish --sidebar and --dashboard options with tyro-dashboard-sidebar and tyro-dashboard-essentials publish tags
