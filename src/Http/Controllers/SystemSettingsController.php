...
class SystemSettingsController extends BaseController {
    ...
    public function update(Request $request): JsonResponse {
        ...
        $validated = $request->validate([
            ...
            'TYRO_DASHBOARD_SIDEBAR_ACCORDION_OPEN_SECTIONS' => 'nullable|integer|min:0|max:50',
            ...
            'TYRO_DASHBOARD_SHOW_RESOURCES_MENU' => 'nullable|boolean',
            ...
            'TYRO_LOGIN_TIDAL_COLOR' => 'nullable|string|max:30',
            'TYRO_LOGIN_TIDAL_SPEED' => 'nullable|numeric|min:0',
            'TYRO_LOGIN_TIDAL_BUBBLES' => 'nullable|boolean',
            'TYRO_LOGIN_BIRDS_COLOR' => 'nullable|string|max:30',
            'TYRO_LOGIN_AURORA_COLOR' => 'nullable|string|max:30',
            'TYRO_LOGIN_AURORA_SPEED' => 'nullable|numeric|min:0',
            'TYRO_LOGIN_AURORA_INTENSITY' => 'nullable|numeric|min:0|max:1',
            'TYRO_LOGIN_PARTICLE_COLOR' => 'nullable|string|max:30',
            'TYRO_LOGIN_PARTICLE_DENSITY' => 'nullable|integer|min:0',
            'TYRO_LOGIN_PARTICLE_LINK_DISTANCE' => 'nullable|integer|min:0',
            'TYRO_LOGIN_PARTICLE_INTERACTIVE' => 'nullable|boolean',
            ...
            'TYRO_LOGIN_LOGO_BORDER_RADIUS' => 'nullable|string|max:20',
    ...
    protected function booleanKeys(): array {
        return [
            ...
            'TYRO_DASHBOARD_SHOW_RESOURCES_MENU',
    ...
    protected function gatherSettings(): array {
        return [
            ...
            'TYRO_DASHBOARD_SIDEBAR_ACCORDION_OPEN_SECTIONS' => config('tyro-dashboard.branding.sidebar_accordion_open_sections'),
            ...
            'TYRO_DASHBOARD_SHOW_RESOURCES_MENU' => config('tyro-dashboard.features.show_resources_menu'),
            ...
            'TYRO_LOGIN_TIDAL_COLOR' => env('TYRO_LOGIN_TIDAL_COLOR', '#1f7a8c'),
            'TYRO_LOGIN_TIDAL_SPEED' => env('TYRO_LOGIN_TIDAL_SPEED', 1),
            'TYRO_LOGIN_TIDAL_BUBBLES' => env('TYRO_LOGIN_TIDAL_BUBBLES', true),
            'TYRO_LOGIN_BIRDS_COLOR' => env('TYRO_LOGIN_BIRDS_COLOR', '#f7f2ec'),
            'TYRO_LOGIN_AURORA_COLOR' => env('TYRO_LOGIN_AURORA_COLOR', '#0b1020'),
            'TYRO_LOGIN_AURORA_SPEED' => env('TYRO_LOGIN_AURORA_SPEED', 1),
            'TYRO_LOGIN_AURORA_INTENSITY' => env('TYRO_LOGIN_AURORA_INTENSITY', 0.5),
            'TYRO_LOGIN_PARTICLE_COLOR' => env('TYRO_LOGIN_PARTICLE_COLOR', '#0f172a'),
            'TYRO_LOGIN_PARTICLE_DENSITY' => env('TYRO_LOGIN_PARTICLE_DENSITY', 80),
            'TYRO_LOGIN_PARTICLE_LINK_DISTANCE' => env('TYRO_LOGIN_PARTICLE_LINK_DISTANCE', 130),
            'TYRO_LOGIN_PARTICLE_INTERACTIVE' => env('TYRO_LOGIN_PARTICLE_INTERACTIVE', true),
            ...
            'TYRO_LOGIN_LOGO_BORDER_RADIUS' => config('tyro-login.branding.logo_border_radius'),
    ...
    protected function defaultValues(): array
    {
        return [
            ...
            'TYRO_DASHBOARD_SIDEBAR_ACCORDION_OPEN_SECTIONS' => 1,
            ...
            'TYRO_LOGIN_LOGO_BORDER_RADIUS' => '0',
