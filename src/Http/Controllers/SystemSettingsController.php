...
class SystemSettingsController extends BaseController {
    ...
    public function update(Request $request): JsonResponse {
        ...
        $validated = $request->validate([
            ...
            'TYRO_LOGIN_REDIRECT_AFTER_LOGIN' => 'nullable|string|max:255',
            'TYRO_LOGIN_REDIRECT_AFTER_LOGOUT' => 'nullable|string|max:255',
        ...
        return response()->json(['success' => true, 'message' => 'System settings saved successfully. Config cache cleared.']);
    }
