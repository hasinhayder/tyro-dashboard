...
<div class="page-header">
    <div class="page-header-row">
        <div>
            ...
            <p class="page-description" style="font-size: 1rem;">Copy-ready building blocks: cards, charts, progress, tables, and status UI.</p>
        </div>
...
<div class="grid-2" style="margin-bottom: 1.5rem;">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title" style="font-size: 1.0625rem;">Requests by Status</h3>
            <span class="badge badge-secondary">Donut</span>
        </div>
        <div class="card-body">
                ...
                <div style="display:grid; grid-template-columns: repeat(7, 1fr); gap: 0.625rem; align-items: end; height: 180px;">
                    @foreach($charts['weekly_bars'] as $bar)
                        <div style="display:flex; flex-direction: column; gap: 0.5rem; align-items: stretch;">
                            <div title="{{ $bar['label'] }}: {{ $bar['value'] }}" style="height: 150px; display:flex; align-items:flex-end;">
