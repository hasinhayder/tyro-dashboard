...
<div class="card" style="margin-top: 1.25rem; margin-bottom: 1.5rem;">
    <div class="card-header">
        <div style="min-width:0;">
            <h3 class="card-title" style="font-size: 1.0625rem;">Reusable Components</h3>
            <p class="page-description" style="margin: 0.25rem 0 0;">Drop-in Blade components. Each block below shows the tag you would use to assemble dashboard pages.</p>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="grid-2" style="margin-bottom: 1.5rem;">
            <div class="card">
                <div class="card-header">
                    <div style="min-width:0;">
                        <h3 class="card-title" style="margin:0;">Card with everything</h3>
                        <p class="page-description" style="margin-top:0.25rem;">A header, body, and footer — all optional.</p>
                    </div>
                    <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
                ...
                <div class="card-body">This is the card body. Pass any content here — text, tables, charts, or forms.</div>
                <div class="card-footer">Updated 5 minutes ago</div>
            </div>

            <div class="card">
                <div class="card-header">
                    <div style="min-width:0;">
                        <h3 class="card-title" style="margin:0;">Avatars & Badges</h3>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="grid-2" style="margin-bottom: 1.5rem;">
            <div class="card">
                <div class="card-header">
                    <div style="min-width:0;">
                        <h3 class="card-title" style="margin:0;">Alerts</h3>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <div style="min-width:0;">
                        <h3 class="card-title" style="margin:0;">Progress</h3>
                    </div>
                </div>
                <div class="card-body">
                    <div style="display:flex; flex-direction:column; gap:1rem;">
        ...
        <div class="card">
            <div class="card-header">
                <div style="min-width:0;">
                    <h3 class="card-title" style="margin:0;">Media</h3>
                </div>
                <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
